...
La información pública proviene de la API y distingue fuentes oficiales, información verificada y avisos comunitarios sin confirmar. Consulta la [arquitectura](docs/04_EXPLANATION/architecture.md), el [inicio local](docs/01_TUTORIALS/local-development.md), el [plan de preparación para producción](docs/04_EXPLANATION/production-readiness-plan.md) y la [auditoría de estándares](docs/04_EXPLANATION/standards-compliance-audit-2026-08-13.md).
