...
La información pública proviene de la API y distingue fuentes oficiales, información verificada y avisos comunitarios sin confirmar. Consulta cómo [operarla](docs/02_HOW_TO/operar.md), la [arquitectura](docs/04_EXPLANATION/architecture.md), el [inicio local](docs/01_TUTORIALS/local-development.md), las [fuentes oficiales y líneas de atención](docs/03_REFERENCE/fuentes-oficiales.md), el [plan de preparación para producción](docs/04_EXPLANATION/production-readiness-plan.md) y la [auditoría de estándares](docs/04_EXPLANATION/standards-compliance-audit-2026-08-13.md).

Cómo contribuir: [CONTRIBUTING.md](CONTRIBUTING.md). Reportar una vulnerabilidad: [SECURITY.md](SECURITY.md). Licencia MIT.
