...
2. Añadir ESLint flat con reglas oficiales de hooks y complejidad.
...
- Componente por dividir: `apps/frontend/src/pages/home/HomePage.tsx` (1.288 líneas en este corte).
...
4. Incorporar ESLint flat con las reglas oficiales de React y React Hooks, sin desactivar reglas
   para ocultar deuda existente.
5. Añadir o ajustar pruebas de los componentes extraídos, cubriendo al menos móvil, cambio entre
...
npm run test:run --workspace=@sos/frontend
